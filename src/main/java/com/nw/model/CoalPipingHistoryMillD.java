...
public class CoalPipingHistoryMillD extends CoalPipingHistory{
    private Long id;
    ...
    public CoalPipingHistoryMillD(Long id, Long hCoalMillId, Date hTime, Float hPipeaVelocity, Float hPipebVelocity, Float hPipecVelocity, Float hPipedVelocity, Float hPipeaDencity, Float hPipebDencity, Float hPipecDencity, Float hPipedDencity, Float hPipeaX, Float hPipeaY, Float hPipeaV, Float hPipebX, Float hPipebY, Float hPipebV, Float hPipecX, Float hPipecY, Float hPipecV, Float hPipedX, Float hPipedY, Float hPipedV) {
        this.id = id;
