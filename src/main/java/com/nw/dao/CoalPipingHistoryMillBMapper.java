...
import com.nw.model.CoalPipingHistoryMillB;
...
public interface CoalPipingHistoryMillBMapper {
    @Delete({
        "delete from bcoal_piping_history",
        "where id = #{id,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long id);

    @Insert({
        "insert into bcoal_piping_history (id, h_time, ",
        "h_pipeA_Velocity, h_pipeB_Velocity, ",
        "h_pipeC_velocity, h_pipeD_velocity, ",
        "h_pipeA_dencity, h_pipeB_dencity, ",
        "h_pipeC_dencity, h_pipeD_dencity, ",
        "h_coal_mill_id, h_pipeA_x, ",
        "h_pipeA_y, h_pipeA_v, h_pipeB_x, ",
        "h_pipeB_y, h_pipeB_v, h_pipeC_x, ",
        "h_pipeC_y, h_pipeC_v, h_pipeD_x, ",
        "h_pipeD_y, h_pipeD_v)",
        "values (#{id,jdbcType=BIGINT}, #{hTime,jdbcType=TIMESTAMP}, ",
        "#{hPipeaVelocity,jdbcType=REAL}, #{hPipebVelocity,jdbcType=REAL}, ",
        "#{hPipecVelocity,jdbcType=REAL}, #{hPipedVelocity,jdbcType=REAL}, ",
        "#{hPipeaDencity,jdbcType=REAL}, #{hPipebDencity,jdbcType=REAL}, ",
        "#{hPipecDencity,jdbcType=REAL}, #{hPipedDencity,jdbcType=REAL}, ",
        "#{hCoalMillId,jdbcType=BIGINT}, #{hPipeaX,jdbcType=REAL}, ",
    ...
    int insert(CoalPipingHistoryMillB record);

    @InsertProvider(type=CoalPipingHistoryMillBSqlProvider.class, method="insertSelective")
    int insertSelective(CoalPipingHistoryMillB record);

    @Select({
        "select",
        "id, h_time, h_pipeA_Velocity, h_pipeB_Velocity, h_pipeC_velocity, h_pipeD_velocity, ",
        "h_pipeA_dencity, h_pipeB_dencity, h_pipeC_dencity, h_pipeD_dencity, h_coal_mill_id, ",
        "h_pipeA_x, h_pipeA_y, h_pipeA_v, h_pipeB_x, h_pipeB_y, h_pipeB_v, h_pipeC_x, ",
        "h_pipeC_y, h_pipeC_v, h_pipeD_x, h_pipeD_y, h_pipeD_v",
        "from bcoal_piping_history",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @ConstructorArgs({
    ...
    CoalPipingHistoryMillB selectByPrimaryKey(Long id);

    @UpdateProvider(type=CoalPipingHistoryMillBSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(CoalPipingHistoryMillB record);

    @Update({
        "update bcoal_piping_history",
        "set h_time = #{hTime,jdbcType=TIMESTAMP},",
          ...
          "h_coal_mill_id = #{hCoalMillId,jdbcType=BIGINT},",
    ...
    int updateByPrimaryKey(CoalPipingHistoryMillB record);
    ...
    List<CoalPipingHistoryMillB> findListBetweenTime(Date begin, Date end);
}