...
public class CoalPipingHistoryMillBSqlProvider {

    public String insertSelective(CoalPipingHistoryMillB record) {
        BEGIN();
        INSERT_INTO("bcoal_piping_history");
    ...
    public String updateByPrimaryKeySelective(CoalPipingHistoryMillB record) {
        BEGIN();
