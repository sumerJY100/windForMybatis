...
public interface CoalPipingHistoryMillAMapper {
    @Delete({
        "delete from acoal_piping_history",
        "where id = #{id,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long id);

    @Insert({
        "insert into acoal_piping_history (id, h_coal_mill_id, ",
        ...
        "#{h_Time,jdbcType=TIMESTAMP}, #{hPipeaVelocity,jdbcType=REAL}, ",
    ...
    int insert(CoalPipingHistoryMillA record);

    @InsertProvider(type=CoalPipingHistoryMillASqlProvider.class, method="insertSelective")
    int insertSelective(CoalPipingHistoryMillA record);
    ...
    CoalPipingHistoryMillA selectByPrimaryKey(Long id);

    @UpdateProvider(type=CoalPipingHistoryMillASqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(CoalPipingHistoryMillA record);

    @Update({
        "update acoal_piping_history",
        "set h_coal_mill_id = #{hCoalMillId,jdbcType=BIGINT},",
          "h_time = #{h_Time,jdbcType=TIMESTAMP},",
    ...
    int updateByPrimaryKey(CoalPipingHistoryMillA record);
    ...
    List<CoalPipingHistoryMillA> findListBetweenTime(Date begin, Date end);
}