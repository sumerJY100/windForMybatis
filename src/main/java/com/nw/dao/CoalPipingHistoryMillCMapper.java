...
public interface CoalPipingHistoryMillCMapper {
    @Delete({
        "delete from ccoal_piping_history",
        "where id = #{id,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long id);

    @Insert({
        "insert into ccoal_piping_history (id, h_coal_mill_id, ",
    ...
    int insert(CoalPipingHistoryMillC record);

    @InsertProvider(type=CoalPipingHistoryMillCSqlProvider.class, method="insertSelective")
    int insertSelective(CoalPipingHistoryMillC record);
    ...
    CoalPipingHistoryMillC selectByPrimaryKey(Long id);

    @UpdateProvider(type=CoalPipingHistoryMillCSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(CoalPipingHistoryMillC record);
    ...
    int updateByPrimaryKey(CoalPipingHistoryMillC record);
    ...
    List<CoalPipingHistoryMillC> findListBetweenTime(Date begin, Date end);
}