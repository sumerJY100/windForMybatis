...
public class CoalPipingHistoryMillASqlProvider {

    public String insertSelective(CoalPipingHistoryMillA record) {
        BEGIN();
        INSERT_INTO("acoal_piping_history");
    ...
    public String updateByPrimaryKeySelective(CoalPipingHistoryMillA record) {
        BEGIN();
