...
public class CoalPipingHistoryMillDSqlProvider {

    public String insertSelective(CoalPipingHistoryMillD record) {
        BEGIN();
        INSERT_INTO("dcoal_piping_history");
    ...
    public String updateByPrimaryKeySelective(CoalPipingHistoryMillD record) {
        BEGIN();
